module IdentCompletionsPromptTest
...
type IdentCompletionsPromptTest () =
    ...
    let myCompletions: ICompletionItems = new CompletionItems (
        ...
        IdentCompletion.getCompletions true (fun () -> myLines)
    )
    ...
    member _.GetNext_GetPrevious_atEndOfLine () =
        ...
        assertResult (Some (1, "t"   )) (myCompletions.GetNext     ())
        ...
        assertResult (Some (1, "t"   )) (myCompletions.GetPrevious ())
