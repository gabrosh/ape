module PromptModifyingPasteBeforeNormalTest
...
type ModifyingPasteBeforeNormalTest () =
    ...
    let performCommand (command: obj) =
        ...
        | :? ModifyingCommand as x ->
            myBuffer.PerformCommand true false (ModifyingCommand x)
        | _                        ->
            invalidOp ""
    ...
    [<TestCase( ""  , "cd"  , [|0; 0; 1|] )>]  // empty line
    [<TestCase( "ab", "cdab", [|0; 0; 1|] )>]  // first char of line
    [<TestCase( "ab", "acdb", [|1; 1; 2|] )>]  // last char of line
    [<TestCase( "ab", "abcd", [|2; 2; 3|] )>]  // EOL
    ...
    [<TestCase( ""  , "cd"  , [|0; 0; 1|] )>]
    [<TestCase( "ab", "cdab", [|0; 0; 1|] )>]
    [<TestCase( "ab", "acdb", [|1; 1; 2|] )>]
    [<TestCase( "ab", "abcd", [|2; 2; 3|] )>]
