...
It can be build also from the command line on Windows and Linux, provided that you have .NET SDK 9.0 installed on your PC (https://dotnet.microsoft.com/en-us/download/dotnet/9.0):
